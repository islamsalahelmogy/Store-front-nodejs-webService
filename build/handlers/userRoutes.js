...
const store_obj = new users_1.UserStore();
const index = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield store_obj.getAll();
    res.status(200).json(users);
});
const show = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const retrieved_users = yield store_obj.show(parseInt(id));
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield store_obj.create({ first_name, last_name, password });
...
const destroy = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield store_obj.delete(parseInt(id));
